...
public class BilateralBillingCalculator extends BillingCalculator {
    ...
    @SuppressWarnings("unused")
    public BilateralBillingCalculator( Service service,
    ...
    */
    ...
    public void bill(List<FileDetailDTO> payLines) {
        ...
        boolean hasCashBack = payment.hasCashBack();
      ...
      /*  Integer percentageFeeDirection = txnType.getFeeDirection();
        ...
        long percentageFee = ( pureCashBack ? 0L : billateralPercentageFee(purchasePortion, rate.getPercentage(),rate.getAmountDirection()) );
        long flatFee = flatFee(purchasePortion, rate.getRate(), rate.getAmountDirection());
        
        double flatVat = Math.abs(percentageFee + flatFee);
        BillingData billingData =
            new BillingData(
                    "BILATERAL",
                    // purchase portion
                    percentageFee, flatFee,
                    ( pureCashBack ? 0L : billateralVat(flatVat, rate.getVat(), rate.getAmountDirection()) ),
