...
///**
// *
// * @author RinusE We produce this report when the entire file has been rejected
// * e.g fatal error with the header/trailor of the file It contains all the
// * errors encountered in the file
// */
//public class CSR003 implements DMCSReportInterface {
//
...
//    private Logger log = Logger.getLogger(CSR003.class);
//
...
//
//        log.debug("Building CSR003 report for " + fileDto.getFileName());
//
...
//
//        String fileName = "CSR003" + fileDto.getFileSubService().substring(0, 1) + "."
