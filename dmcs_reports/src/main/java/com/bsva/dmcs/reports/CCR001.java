...
//
//	private static final String CARDSERVICE_VISA_CREDIT = "VISA CARD";
//	private static final String CARDSERVICE_VISA_DEBIT = "VISA DEBIT";
//	private static final String CARDSERVICE_MASTERCARD_CREDIT = "MASTERCARD";
//	private static final String CARDSERVICE_MASTERCARD_DEBIT = "MASTERDEBIT";
//	private static final String CARDSERVICE_AMERICAN_EXPRESS = "AMERICAN EXPRESS";
//	private static final String CARDSERVICE_DINERS = "DINERS";
//	private static final String CARDSERVICE_FLEET = "FLEET CARD";
//
//	private static final String SUBTOTALS = "SUB TOTALS";
//	private int subTotalsCountCalc = 0;
//	private long subTotalsAmountCalc = 0;
...
//	private long subTotalsNetAmountCalc = 0;
//
...
//		CCR001 ccr001 = new CCR001(subService,1);
//
//	}
//
//	public List<com.bsva.dcms.commons.dto.views.temp.CsvCcr00XDataViewDto> filterListCard(List<com.bsva.dcms.commons.dto.views.temp.CsvCcr00XDataViewDto> list){
//
//		for (com.bsva.dcms.commons.dto.views.temp.CsvCcr00XDataViewDto csvCcr00XDataViewDto : list) {
//
//				if( csvCcr00XDataViewDto.getCardDescription().equals(CARDSERVICE_VISA_CREDIT) ||
//					csvCcr00XDataViewDto.getCardDescription().equals(CARDSERVICE_VISA_DEBIT) ||
//					csvCcr00XDataViewDto.getCardDescription().equals(CARDSERVICE_MASTERCARD_CREDIT) ||
//					csvCcr00XDataViewDto.getCardDescription().equals(CARDSERVICE_MASTERCARD_DEBIT) ||
//					csvCcr00XDataViewDto.getCardDescription().equals(CARDSERVICE_AMERICAN_EXPRESS) ||
//					csvCcr00XDataViewDto.getCardDescription().equals(CARDSERVICE_FLEET) ||
//					csvCcr00XDataViewDto.getCardDescription().equals(CARDSERVICE_DINERS) ){
...
//	public CCR001(String subService,int oneOrFive) throws Exception {
//	try{
...
//		List<com.bsva.dcms.commons.dto.views.temp.CsvCcr00XDataViewDto> listVISA = filterListCard(dtoList);
//
...
//
//				if(addressBool){
//					//getting the address of the issuer
...
//
//					//gettting the address of the acquirer
...
//		    //if(dto.getBillingFeeAmount() > 0){
//		    ccr001AND5Report.setTransAmount(String.format(NUMBER_FORMAT, Double.parseDouble("" + dto.getTransactionValue())));
...
//		    long netAmount = (long) (dto.getBillingVat()+dto.getBillingFee()+ dto.getBillingFeeAmount()+dto.getTransactionValue());
//		    ccr001AND5Report.setTransNetAmount(String.format(NUMBER_FORMAT, Double.parseDouble(String.valueOf(netAmount))));
...
//			long subTotalNetAmount = (long) (subTotalsNetAmountCalc + dto.getBillingVat()+dto.getBillingFee()+ dto.getBillingFeeAmount()+dto.getTransactionValue());
//			subTotalsNetAmountCalc = subTotalNetAmount;
//
//			//getting the grandtotals
...
//
//			summaryPage.setCount(String.valueOf(summaryTotalsCountCalc));
//			summaryPage.setAmount(String.valueOf(new BigDecimal(summaryTotalsAmountCalc)));
//			summaryPage.setInterchange(String.valueOf(new BigDecimal(summaryTotalsInterchangeCalc)));
//			summaryPage.setVat(String.valueOf(new BigDecimal(summaryTotalsVatCalc)));
//			summaryPage.setTotalCharges(String.valueOf(new BigDecimal(summaryTotalsTotalChargesCalc)));
//			summaryPage.setNetAmount(String.valueOf(new BigDecimal(summaryTotalsNetAmountCalc)));
//
...
//				CSFMemberServiceDTO csfMemberServiceDTO = getMembers(dto.getAcquirerBankCode());
//
//				//setting the Address of the issuer
//				FromAddress address = new FromAddress();
//				address.setAccountNumber(csfMemberServiceDTO.getAccountNumber());
//				address.setAcquirerInd(csfMemberServiceDTO.getAcquirerInd());
//				address.setBankCode(csfMemberServiceDTO.getBranchCode());
...
//				ccr001AND5Report.setReportLine(reportLine);
//
//				//setting the Address of the acquirer
//				CSFMemberServiceDTO toCsfMemberServiceDTO = getMembers(dto.getIssuerBankCode());
...
//				  if(dto.getReportSortSequence() == 21){
//					  initializeSummaryPage();
//				  }
//				  //setting the Summary page
...
//			        	 double netSalesAmount = dto.getBillingVat()+dto.getBillingFee()+ dto.getBillingFeeAmount()+dto.getTransactionValue();
//			        	 summaryPage.setSalesDraftNetAmount(String.valueOf(netSalesAmount + (dto.getBillingVat()+dto.getBillingFee()+ dto.getBillingFeeAmount()+dto.getTransactionValue())));
//			             break;
...
//			        	 summaryPage.setCashAdvancesCount(String.valueOf(vatAmount18=+dto.getVolume()));
...
//			        	 summaryPage.setChargeBacksCa(dto.getTransactionDescription());
//			        	 summaryPage.setChargeBacksCaCount(String.valueOf(volumes19 += dto.getVolume()));
//			        	 summaryPage.setChargeBacksCaAmount(String.valueOf(feeAmount19 += dto.getTransactionValue()));
//			        	 summaryPage.setChargeBacksCaVat(String.valueOf(vatAmount19 += dto.getBillingVat()));
...
//			        	 summaryPage.setReversalsCaCount(String.valueOf(values20 += dto.getVolume()));
//			        	 summaryPage.setReversalsCaAmount(String.valueOf(feeAmount20 += dto.getTransactionValue()));
//			        	 summaryPage.setReversalsCaVat(String.valueOf(vatAmount20 += dto.getBillingVat()));
...
//			        	 summaryPage.setSubTotalsCaCount(String.valueOf(volumes21 += dto.getVolume()));
//			        	 summaryPage.setSubTotalsCaAmount(String.valueOf(feeAmount21 += dto.getTransactionValue()));
//			        	 summaryPage.setSubTotalsCaVat(String.valueOf(vatAmount21 += dto.getBillingVat()));
...
//				"CCR001" +
//				SUB_SERVICE_MNEMONICS.get(headerRecord.getSubservice()) +  "." +
...
//		boolean header = true;
//
//		for (CCR001AND5Reports ccr001and5Reports2 : listData) {
...
//				bw.flush();
//
//				ccr001AND5ReportsData.setTo(ccr001and5Reports2.getToAddres().getContactName());
//				ccr001AND5ReportsData.setFrom(ccr001and5Reports2.getFromAddres().getContactName());
//				bw.newLine();
//				ccr001AND5ReportsData.setToAddress(ccr001and5Reports2.getToAddres().getMemberAddress1());
//				ccr001AND5ReportsData.setFromAddress(ccr001and5Reports2.getFromAddres().getMemberAddress1());
//				bw.newLine();
//				ccr001AND5ReportsData.setToAddress2(ccr001and5Reports2.getToAddres().getMemberAddress2());
//				ccr001AND5ReportsData.setFromAddress2(ccr001and5Reports2.getFromAddres().getMemberAddress2());
//				bw.newLine();
//				ccr001AND5ReportsData.setToAddress3(ccr001and5Reports2.getToAddres().getMemberAddress3());
//				ccr001AND5ReportsData.setFromAddress3(ccr001and5Reports2.getFromAddres().getMemberAddress3());
//				bw.newLine();
//				ccr001AND5ReportsData.setToAddress4(ccr001and5Reports2.getToAddres().getMemberAddress4());
//				ccr001AND5ReportsData.setFromAddress4(ccr001and5Reports2.getFromAddres().getMemberAddress4());
//				bw.newLine();
//				ccr001AND5ReportsData.setToVatRegNo(ccr001and5Reports2.getToAddres().getVatRegNumber());
//				ccr001AND5ReportsData.setFromVatRegNo(ccr001and5Reports2.getFromAddres().getVatRegNumber());
//				bw.newLine();
//
//
...
//	}
//
//	private void writeSummarypage(SummaryPage summaryPage) {
//		SummaryPage page = new SummaryPage();
//		 page.setAmount(summaryPage.getAmount());
//		 page.setVat(summaryPage.getVat());
//		 page.setCount(summaryPage.getCount());
//		 page.setTotalCharges(summaryPage.getTotalCharges());
//		 page.setNetAmount(summaryPage.getNetAmount());
//		 page.setInterchange(summaryPage.getInterchange());
//
...
//	}
//	public void initializeSummaryPage(){
//		summaryTotalsCountCalc = 0;
//		summaryTotalsAmountCalc = 0;
//		summaryTotalsInterchangeCalc = 0;
//		summaryTotalsVatCalc = 0;
//		summaryTotalsTotalChargesCalc = 0;
//		summaryTotalsNetAmountCalc = 0;
//
//	}
//
//	public CSFMemberServiceDTO getMembers(int oneOrfive) throws DAOException{
//
//		CSFMemberServiceDTO csfMemberServiceDTO = new CSFMemberServiceDTO();
//		CSFMembersServiceDAO dao = new CSFMembersServiceDAO();
//		csfMemberServiceDTO.setBankCode(oneOrfive);
//		CSFMemberServiceDTO csfMemberService  = dao.retrieve(csfMemberServiceDTO);
