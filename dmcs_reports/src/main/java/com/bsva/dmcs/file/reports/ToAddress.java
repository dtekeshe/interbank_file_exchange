...
public class ToAddress {
	...
	private String header01RecordLength;
	...
	private String trailer98RecordLength;
	private String trailer99RecordLength;
	...
	public String getHeader01RecordLength() {
		return header01RecordLength;
	}


	public void setHeader01RecordLength(String header01RecordLength) {
	...
	public String getTrailer98RecordLength() {
		return trailer98RecordLength;
	}


	public void setTrailer98RecordLength(String trailer98RecordLength) {
		this.trailer98RecordLength = trailer98RecordLength;
	}


	public String getTrailer99RecordLength() {
		return trailer99RecordLength;
	}


	public void setTrailer99RecordLength(String trailer99RecordLength) {
