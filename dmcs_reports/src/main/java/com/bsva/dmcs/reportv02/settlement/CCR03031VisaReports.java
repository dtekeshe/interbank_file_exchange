...
public class CCR03031VisaReports {
	/*
	...
	public void writeCsvFile31(String subService) {
		...
		for (Integer acquiringMember : integerSet) {
			...
			List<Ccr03031VisaEntity> listData = new CCR031VisaReportDAO().getCCR031Data(number,"ACQUIRER");
			try {
				...
				int numCount = 2;
				String subHeader = "ACQUIRER, ISSUER, CARD TYPE,CARD NUMBER,TRANSACTION CODE,TRANSACTION DATE,BANKSERV REF NO,"
	...
	public static void main(String[] args) {
		new CCR03031VisaReports().writeCsvFile31("FLEET CARD");
	}
