...
public class CCR030McardReports {
	/*
	...
	public void writeCsvFile30(String subService) {
		...
		for (Integer issuingMember : integerSet) {
			...
			List<Ccr03031McardEntity> listData = new CCR031McardReportDAO().getCCR03031Data(number,"ISSUER");
			...
			try {
				...
				String subHeader = "ISSUER,ACQUIRER, CARD TYPE,CARD NUMBER,TRANSACTION CODE,PROCESSING CODE,TRANSACTION DATE,TRANSACTION TIME,BANKSERV"
	...
	public static void main(String[] args) {
		new CCR030McardReports().writeCsvFile30("VISA CARD");
	}
