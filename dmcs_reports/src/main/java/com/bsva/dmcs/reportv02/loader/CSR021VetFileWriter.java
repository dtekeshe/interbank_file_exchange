 ...
 * TODO Document
 */
public class CSR021VetFileWriter extends VetFileWriter {

    private final static String REPORT_ID = "021";

    public CSR021VetFileWriter(
    ...
    public void write(Integer issuerMemberCode,
        ...
        stats.addRejectedControlRecCount(1L);
        write(issuerMemberCode, filename, header, errors, stats, null, "VET REPORT");
    }
    ...
    protected void writerHeader( PrintWriter out,
        ...
        // header line 3
        s =
                format( subServiceID + " " +reportName,    65, ' ', Justification.RIGHT);
        out.println( s + LINE_SEPARATOR + LINE_SEPARATOR);
