 ...
 * TODO Document
 */
public class CSR023VetFileWriter extends VetFileWriter {

    private final static String REPORT_ID = "023";

    public CSR023VetFileWriter(
    ...
    public void write(Integer issuerMemberCode,
        ...
        write(issuerMemberCode, filename, header, errors, fileStats, 100, "VET REPORT");
    }
