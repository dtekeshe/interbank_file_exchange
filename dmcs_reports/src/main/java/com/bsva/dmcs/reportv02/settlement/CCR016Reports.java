...
public class CCR016Reports {
	...
	private static String reportId = "016";
	...
	public void writeCsvFile(String subService) {
		...
		List<Css_Stats_View> listData = new CssStatsViewDAO().getCSS0016Reports(subService);
	...
	public static void main(String[] args) {
		new CCR016Reports().writeCsvFile("FLEET CARD");
	}
