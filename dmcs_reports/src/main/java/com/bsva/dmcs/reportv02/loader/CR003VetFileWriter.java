...
public class CR003VetFileWriter extends CRVetFileWriter {
    ...
    public void writeData(Integer issuerMemberCode,
        ...
        writeData(issuerMemberCode, filename, header, errors, fileStats, null, "VALIDATION REPORT");
    }
