...
import com.bsva.entities.Css_Stats_View;
	...
	public class CCR14Reports {
		...
		private static String reportId = "014";
	   ...
	   // private static private BigInteger countNum = BigInteger.ONE;
		...
		public void writeCsvFile(String subService) {
			...
			//Map<Integer,Css_Stats_View> dtoList =  new Css_Stats_View_DAO().getCSS0014Reports(subService);
			List<Css_Stats_View> listData =  new Css_Stats_View_DAO().getCSS0014Reports(subService);
			...
			for (Integer issuingMember : datasetList) {
			  try {
				...
				String filename = deliveryServices.getFilenamePrefix()+codeDetails.getMemberTapeid()+ padLeftString(""+numberCount,3)+"D";
		...
		public static void main(String[] args){
			new CCR14Reports().writeCsvFile("FLEET CARD");
		}
