 ...
 */
public class ReportCreatorTest2 extends TestCase {
    
    public ReportCreatorTest2(String testName) {
        super(testName);
    }
    ...
    public void testReportCreator() throws ReportCreatorException, TransformerException {
        ...
        File xmlFile = new File("C:\\CCCS\\REPORTS\\CCR001V.0001.044328675.xml");
        //File xslFile = new File("C:\\CCCS\\REPORTS\\ccr001_report.xml");
        File xslFile = new File("C:\\CCCS\\REPORTS\\ccrresult.xsl");
