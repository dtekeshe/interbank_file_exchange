 ...
 */
@Embeddable
public class CsoScheduleTimesPK implements Serializable {
    /**
	 * 
	 */
    ...
    public CsoScheduleTimesPK() {
    }

    public CsoScheduleTimesPK(String process, String service, String subService) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CsoScheduleTimesPK)) {
            return false;
        }
        CsoScheduleTimesPK other = (CsoScheduleTimesPK) object;
    ...
    public String toString() {
        return "com.bsva.dmcs.entities.CsoScheduleTimesPK[ process=" + process + ", service=" + service + ", subService=" + subService + " ]";
    }
