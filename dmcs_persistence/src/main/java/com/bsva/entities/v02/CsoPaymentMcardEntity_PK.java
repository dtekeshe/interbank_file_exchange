...
@Embeddable
public class CsoPaymentMcardEntity_PK implements Serializable{
	...
	public CsoPaymentMcardEntity_PK(){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CsoPaymentMcardEntity_PK other = (CsoPaymentMcardEntity_PK) obj;
	...
	public String toString() {
		...
		builder.append("CsoPaymentMcardEntity_PK [issuerMember=");
