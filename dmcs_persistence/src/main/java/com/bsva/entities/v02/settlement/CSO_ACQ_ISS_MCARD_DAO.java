...
public class CSO_ACQ_ISS_MCARD_DAO extends AbstractDao<CsoCCR030AcqIssEntity, Void> {

	private final static String ACQ_ISSUER_PAIR = "SELECT  DISTINCT ACQUIRER_MEMBER,ISSUER_MEMBER from CSO_CCR030_MCARD ORDER BY ACQUIRER_MEMBER ASC ,ISSUER_MEMBER ASC ";
