...
@Entity
@DynamicUpdate
public class CCR00XFinalTotalsDataSettleEntity implements Serializable {

    @EmbeddedId
    private CCR00XFinalTotalsDataSettleKey id;
    ...
    public CCR00XFinalTotalsDataSettleKey getId() {
		return id;
	}

	public void setId(CCR00XFinalTotalsDataSettleKey id) {
		this.id = id;
	}
