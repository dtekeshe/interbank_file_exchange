...
import com.bsva.entities.v02.endofservice.AcquirerIssuerLastFileStatusEntity;
 ...
 * TODO Document
 */
public class AcquirerIssuerLastFileStatusDAO extends AbstractDao<AcquirerIssuerLastFileStatusEntity, Void> {
    ...
    public String fileStatus(AcquirerIssuerPairKey id, String seqNumber ) {
        ...
        // execute
        AcquirerIssuerLastFileStatusEntity entity
                = uniqueResult(LAST_FILE_STATUS_SQL,params, AcquirerIssuerLastFileStatusEntity.class);
