...
public class CssStatsViewDAO extends AbstractDao<Css_Stats_View, Void>{
		...
		" SELECT ISSUER_BIN"+
	          ...
	          // AND PROCESS_MONTH = '201403'
	               " GROUP BY ISSUER_BIN "+
	                  ...
	                  " ,NVL(INTERCHANGE_RATE_DESIGNATOR,0)"+
	                    " ,NVL(TRANSACTION_DESCRIPTION,' ')"+
	           " ORDER BY NVL(ACQUIRING_MEMBER,0)"+
	                   " ,NVL(TO_NUMBER(CARD_TYPE),0)"+
	                   " ,NVL(ISSUING_MEMBER,0)"+
	                   " ,ISSUER_BIN"+
	                   " ,NVL(CARD_DESCRIPTION,' ')"+
		    ...
		    public List<Css_Stats_View> getCSS0016Reports(String cardDescription) {
		        // prepare params
		    ...
		    public List<Css_Stats_View> getCSS0017Reports(String cardDescription) {
		        // prepare params
		        Map<String, Object> params = new HashMap<>();
		        //params.put("processDate", processDate);
		        params.put("cardDescription", cardDescription);
