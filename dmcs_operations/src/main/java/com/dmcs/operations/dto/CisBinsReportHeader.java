...
public class CisBinsReportHeader {
	...
	public String toString() {
		...
		builder.append(binDescription == null ? "" : StringUtil.leftJustify(String.valueOf(binDescription),StringUtil.SPACE_STRING, 35));
		builder.append(DeletionDate == null ? "" : StringUtil.leftJustify(String.valueOf(DeletionDate),StringUtil.SPACE_STRING, 15));
		builder.append(cardType == null ? "" : StringUtil.leftJustify(String.valueOf(cardType),StringUtil.SPACE_STRING, 15));
		builder.append(oldCardType == null ? "" : StringUtil.leftJustify(String.valueOf(oldCardType),StringUtil.SPACE_STRING, 11));
		builder.append(fuelAllowed  == null ? "" : StringUtil.leftJustify(String.valueOf(fuelAllowed),StringUtil.SPACE_STRING, 11));
		builder.append(issAcqBoth  == null ? "" : StringUtil.leftJustify(String.valueOf(issAcqBoth),StringUtil.SPACE_STRING, 14));
		builder.append(liveDate  == null ? "" : StringUtil.leftJustify(String.valueOf(liveDate),StringUtil.SPACE_STRING, 14));
