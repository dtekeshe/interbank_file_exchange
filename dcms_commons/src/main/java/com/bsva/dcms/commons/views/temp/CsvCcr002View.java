...
public class CsvCcr002View {
	...
	private List<CsvCcr002ViewDto> csvCcr002ViewDtos = new ArrayList<>();;
	...
	public List<CsvCcr002ViewDto> execute(){
		 ...
		 * if its a one way relationship we dont return anything ?? why
		 */
...
//				csvCcr002ViewDtos.add(csvCcr002ViewDto);
	...
	/*
	 * get transaction costs regardless of subservice
	 */
	public Map<String , TranCosts> buildTranCosts(){
		...
		for(CsvCcr00XDataViewDto csvCcr00XDataViewDto  : csvCcr00XDataViewDtos){
			...
			double cost = csvCcr00XDataViewDto.getBillingFee() + csvCcr00XDataViewDto.getBillingFeeAmount() + csvCcr00XDataViewDto.getBillingVat();
